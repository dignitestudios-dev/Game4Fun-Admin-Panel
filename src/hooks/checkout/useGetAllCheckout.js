...
const useGetAllCheckout = (search, status, page, limit) => {
  ...
  const getAllCheckout = async () => {
    ...
    try {
      const response = await api.getAllCheckout(search, status, page, limit);
      // const response = {
      //   success: true,
...
// console.log(response)
  ...
  return { loading, checkouts, totalPages, getAllCheckout };
};

export default useGetAllCheckout;
