...
const useGetAllQuote = (search, status, page, limit) => {
  ...
  const getAllQuote = async () => {
    ...
    try {
      const response = await api.getAllQuote(search, status, page, limit);
      // const response = {
      //   success: true,
...
console.log(response)
  ...
  return { loading, quotes, totalPages, getAllQuote };
};

export default useGetAllQuote;
